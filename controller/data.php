...
// check if session has logged-in user

require '../controller/header.html';
...
<form method="POST">
    <table>
        ...
        <tr>
            <th>
                ID<br>
                <label for="idInputMin"></label><input type="number" step="0.01" id="idInputMin" name="idInputMin"><br>
                <label for="idInputMax"></label><input type="number" step="0.01" id="idInputMax" name="idInputMax">
            </th>
            <th>
                Licence Plate<br>
                <label for="licencePlateInput"></label><input type="text" id="licencePlateInput" name="licencePlateInput">
            </th>
            <th>
                Date and Time<br>
                <label for="dateTimeInputMin"></label><input type="date" id="dateTimeInputMin" name="dateTimeInputMin"><br>
                <label for="dateTimeInputMax"></label><input type="date" id="dateTimeInputMax" name="dateTimeInputMax">
            </th>
            <th>
                Petrol Station<br>
                <label for="petrolStationInput"></label><input type="text" id="petrolStationInput" name="petrolStationInput">
            </th>
            <th>
                Fuel Type<br>
                <label for="fuelTypeInput"></label><input type="text" id="fuelTypeInput" name="fuelTypeInput">
            </th>
            <th>
                Refueled<br>
                <label for="refueledInputMin"></label><input type="number" step="0.01" id="refueledInputMin" name="refueledInputMin"><br>
                <label for="refueledInputMax"></label><input type="number" step="0.01" id="refueledInputMax" name="refueledInputMax">
            </th>
            <th>
                Currency<br>
                <label for="currencyInput"></label><input type="text" id="currencyInput" name="currencyInput">
            </th>
            <th>
                Fuel Price<br>
                <label for="fuelPriceInputMin"></label><input type="number" step="0.01" id="fuelPriceInputMin" name="fuelPriceInputMin"><br>
                <label for="fuelPriceInputMax"></label><input type="number" step="0.01" id="fuelPriceInputMax" name="fuelPriceInputMax">
            </th>
            <th>
                Odometer<br>
                <label for="odometerInputMin"></label><input type="number" id="odometerInputMin" name="odometerInputMin"><br>
                <label for="odometerInputMax"></label><input type="number" id="odometerInputMax" name="odometerInputMax">
            </th>
            <th>
                Total<br>
                <label for="totalInputMin"></label><input type="number" step="0.01" id="totalInputMin" name="totalInputMin"><br>
                <label for="totalInputMax"></label><input type="number" step="0.01" id="totalInputMax" name="totalInputMax">
            </th>
        </tr>
        </tbody>
    </table>
